          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border-2 border-red-600 shadow-2xl">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-2xl font-bold text-white uppercase tracking-tight">Disclaimer</h3>
              </div>
              <button
                onClick={handleClose}
            ...
            <div className="p-6 max-h-96 overflow-y-auto">
              <div className="space-y-4 text-gray-300">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="text-white font-bold mb-2 uppercase text-sm tracking-wider">General Information</h4>
                  ...
                  <div>
                    <h4 className="text-white font-bold mb-2 uppercase text-sm tracking-wider">No Professional Advice</h4>
                    <p className="text-sm leading-relaxed">
                  ...
                  <div>
                    <h4 className="text-white font-bold mb-2 uppercase text-sm tracking-wider">Limitation of Liability</h4>
                    <p className="text-sm leading-relaxed">
                  ...
                  <div>
                    <h4 className="text-white font-bold mb-2 uppercase text-sm tracking-wider">External Links</h4>
                    <p className="text-sm leading-relaxed">
